...
public class MetalMelody implements RobotConstants {
  ...
  // Ports and IDs
  private static final CanDeviceId GYRO = new CanDeviceId(9, CANBUS_NAME);

  private static final CanDeviceId FRONT_LEFT_DRIVE_MOTOR = new CanDeviceId(1, CANBUS_NAME);
  private static final CanDeviceId FRONT_LEFT_STEER_MOTOR = new CanDeviceId(5, CANBUS_NAME);
  private static final CanDeviceId FRONT_LEFT_STEER_ENCODER = new CanDeviceId(5, CANBUS_NAME);

  private static final CanDeviceId FRONT_RIGHT_DRIVE_MOTOR = new CanDeviceId(3, CANBUS_NAME);
  private static final CanDeviceId FRONT_RIGHT_STEER_MOTOR = new CanDeviceId(7, CANBUS_NAME);
  private static final CanDeviceId FRONT_RIGHT_STEER_ENCODER = new CanDeviceId(7, CANBUS_NAME);

  private static final CanDeviceId BACK_LEFT_DRIVE_MOTOR = new CanDeviceId(2, CANBUS_NAME);
  private static final CanDeviceId BACK_LEFT_STEER_MOTOR = new CanDeviceId(6, CANBUS_NAME);
  private static final CanDeviceId BACK_LEFT_STEER_ENCODER = new CanDeviceId(6, CANBUS_NAME);

  private static final CanDeviceId BACK_RIGHT_DRIVE_MOTOR = new CanDeviceId(4, CANBUS_NAME);
  private static final CanDeviceId BACK_RIGHT_STEER_MOTOR = new CanDeviceId(8, CANBUS_NAME);
  private static final CanDeviceId BACK_RIGHT_STEER_ENCODER = new CanDeviceId(8, CANBUS_NAME);
  ...
  private static final LinearVelocity MAX_SPEED = MetersPerSecond.of(4.66);
  ...
  private static final Angle FRONT_LEFT_ENCODER_OFFSET = Rotations.of(-0.17333984375);
  private static final Angle FRONT_RIGHT_ENCODER_OFFSET = Rotations.of(-0.18505859375);
                ...
                new SwerveModuleConfiguration[] {
                  new SwerveModuleConfiguration.Builder()
                      ...
                      .setDriveClosedLoopOutput(
                          SwerveModuleConfiguration.ClosedLoopOutputType.Voltage)
                      .setSteerClosedLoopOutput(
                          SwerveModuleConfiguration.ClosedLoopOutputType.Voltage)
