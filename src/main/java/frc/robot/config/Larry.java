...
public class Larry implements RobotConstants {
  ...
  private static final CanDeviceId FRONT_LEFT_DRIVE_MOTOR = new CanDeviceId(1, CANIVORE_NAME);
  private static final CanDeviceId FRONT_LEFT_STEER_MOTOR = new CanDeviceId(5, CANIVORE_NAME);
  private static final CanDeviceId FRONT_LEFT_STEER_ENCODER = new CanDeviceId(5, CANIVORE_NAME);

  private static final CanDeviceId FRONT_RIGHT_DRIVE_MOTOR = new CanDeviceId(3, CANIVORE_NAME);
  private static final CanDeviceId FRONT_RIGHT_STEER_MOTOR = new CanDeviceId(7, CANIVORE_NAME);
  private static final CanDeviceId FRONT_RIGHT_STEER_ENCODER = new CanDeviceId(7, CANIVORE_NAME);

  private static final CanDeviceId BACK_LEFT_DRIVE_MOTOR = new CanDeviceId(2, CANIVORE_NAME);
  private static final CanDeviceId BACK_LEFT_STEER_MOTOR = new CanDeviceId(6, CANIVORE_NAME);
  private static final CanDeviceId BACK_LEFT_STEER_ENCODER = new CanDeviceId(6, CANIVORE_NAME);

  private static final CanDeviceId BACK_RIGHT_DRIVE_MOTOR = new CanDeviceId(4, CANIVORE_NAME);
  private static final CanDeviceId BACK_RIGHT_STEER_MOTOR = new CanDeviceId(8, CANIVORE_NAME);
  private static final CanDeviceId BACK_RIGHT_STEER_ENCODER = new CanDeviceId(8, CANIVORE_NAME);
