...
public class DriveSubsystem extends SubsystemBase implements VisionSubsystem.VisionConsumer {
  ...
  private final ModuleSubsystem[] modules = new ModuleSubsystem[4]; // FL, FR, BL, BR
  ...
  public DriveSubsystem(
    ...
    setpointGenerator =
        new SwerveSetpointGenerator(constants.getPathPlannerConfig(), RotationsPerSecond.of(5));
    previousSetpoint =
